    ...
    window.onscroll = function() {
        ...
        if (prevScrollPos > currentScrollPos) {
            document.getElementById("site-header","userSidebar").style.transform = "translateY(0)";
        } else {
            document.getElementById("site-header","userSidebar").style.transform = "translateY(-100%)";
        }
    
        // 如果用户的侧边栏是打开的，则不要处理滚动事件
        if ($("#userSidebar").hasClass("show")) {
            return;
        }
