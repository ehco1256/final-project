...
<body>
    ...
    <header id="site-header">
            ...
            <div>
                <div class="collapse" id="collapseExample">
                    <div class="card card-body">
						...
						<a href="Experience.html" style="color: black;">組員資訊</a>
                    </div>
                </div>
        ...
        <div class="sidebar" id="userSidebar">  <!--登入與註冊頁面-->
            ...
            <!-- 登入表單 -->
            <form id="loginForm" method="post" action="check.jsp">
                ...
                <div class="mb-3"> <!-- 登入頁面的電子郵件信箱輸入 -->
                    ...
                    <input type="email" class="form-control" id="loginUsername" name="id">
                </div>
                <div class="mb-3"> <!-- 登入頁面的密碼輸入 -->
                    ...
                    <input type="submit" class="btn btn-dark" value="登入"> <a href="backstage.html" style="color: #c6c6c6;text-decoration:none;"></a></button> <!-- 登入按鈕，等後端進行資料驗證，現在BATE用才會連接backstage.html，之後記得更改-->    <!-- 如果資料與DataBase的相同跳轉到backstage.html-->
            </form>
        
            <!-- 註冊表單 -->
            <form id="registerForm" style="display: none;" method="post" action="checkregister.jsp">
			
                <img src="p/logo/-2.svg" alt="">
                <div id="formText">註冊</div>
                <div class="mb-3"> <!-- 註冊頁面的姓名輸入 -->
                    <label for="Name" class="form-label">姓名</label>
                    <input type="text" class="form-control" id="registerUsername" name="registername" required>
                </div>

                <div class="mb-3"> <!-- 註冊頁面的電子郵件輸入 -->
                    <label for="registerUsermail" class="form-label">電子郵件信箱</label>
                    <input type="email" class="form-control" id="registerUsername" name="registerid" required>
                </div>
                <div class="mb-3"> <!-- 註冊頁面的密碼輸入 -->
                    <label for="registerPassword" class="form-label">密碼</label>
                    <div class="input-group">
                        <input type="password" class="form-control" id="registerPassword" name="registerpwd" required>
                ...
                <input type="submit" class="btn btn-success" value="註冊"> </button> <!-- 註冊按鈕 -->  <!-- 將資料新增到DataBase-->
            </form>
    ...
    <main>
        <section class="v"> <!--影片廣告-->
            <video src="v/background_video.mp4" autoplay loop muted 
                style="width:  100%; height: 10%; z-index: 80; margin-bottom: 40px; "></video>
            <div class="start">
                <h3>2023年秋冬新款</h3>
                <h4><a href="" title="know_more" style="color: white;">瞭解更多</a></h4>
            </div>
        </section>
        <h5 style="font-weight: bold;">最精華的時尚，只屬於最完美的你</h5> <!-- 小文字 -->
        <section class="product"> <!--商品-->
            <section class="Product_card" >
                <a href="ring.html" style="color: #212121;text-decoration:none">
                    <img src="p/ring.jpg" alt="">
                    <p>戒指</p>
                </a>
            </section>
            <section class="Product_card">
                <a href="necklace.html" style="color: #212121;text-decoration:none">
                    <img src="p/li.jpg" alt="">
                    <p>項鍊</p>
                </a>
            </section>
            <section class="Product_card">
                <a href="perfume.jsp" style="color: #212121;text-decoration: none;">
                    <img src="p/water.jpg" alt="">  
                    <p>香水</p>
                </a>
...
if (session.isNew()) {
    counter++;
    application.setAttribute("counter", counter); // 將更新後的整數計數器值存儲在應用程式屬性中
}
%>
...
<footer>
	...
	<p style="font-size: 10pt;">網站瀏覽人次:<%=counter%>人</P>
